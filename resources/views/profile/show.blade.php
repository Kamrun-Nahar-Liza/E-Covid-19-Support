...
<div class="page-wrapper">
            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                        <div><a href="{{ route('profiles.edit', $data->id)}}" class="btn btn-info">
             ...
             <form action="{{ route('profiles.destroy' , $data->id) }}" method="post" onsubmit="return confirm('Are you sure you want to delete?')">
  ...
  <hr>
            <div>
                <a href="{{ route('profiles.index')}}" class="btn btn-primary lg">
                Back to Doctor List
            </a>
            </div>
