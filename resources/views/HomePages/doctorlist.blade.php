            ...
            <nav class="">
                ...
                <ul class="menu">
                    ...
                    <!-- <li><a href="./about.html">About</a></li> -->
                            ...
                            <li class="active"><a href="{{ route('doctorlist')}}">Doctors</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center mb-3">
                            ...
                            <p>
                                They will suggest you proper covid-19 instruction
                            </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="item-block-07">
                            <div class="item-pic">
                                <img src="{{ asset('uploads/doctor/' . $profile->profile_pic) }}" alt="team">
